...
def get_play_time(file, slot):
    # Added by duffry 20240303
    # Offsets for each character slot's play time
    offsets = [
        0x1901d0e+38, 0x1901f5a+38, 0x19021a6+38, 0x19023f2+38,
        0x190263e+38, 0x190288a+38, 0x1902ad6+38, 0x1902d22+38,
        0x1902f6e+38, 0x19031ba+38
    ]
    
    with open(file, "rb") as f:
        # Seek to the correct offset for the given slot
        f.seek(offsets[slot-1])
        # Read 4 bytes (32 bits) and convert to integer
    ...
    # Format the play time as a string "HH:MM:SS"
